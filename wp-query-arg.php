...
//////Author Parameters - Show posts associated with certain author.
    ...
    'author_name' => 'kuldeep',              //(string) - use 'user_nicename' (NOT name)
...
//////Category Parameters - Show posts associated with certain categories.
    ...
    'category_name' => 'team, work',          //(string) - Display posts that have these categories, using category slug.
    'category_name' => 'team+work',           //(string) - Display posts that have "all" of these categories, using category slug.
